                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-gray-400">
                            <li>
                                ...
                                >
                                    <span className="mr-2">›</span> {t.footer.links.about}
                                </Link>
                            </li>
                            <li>
                                <Link
                                    ...
                                    className="hover:text-white transition-colors flex items-center"
                                >
                                    <span className="mr-2">›</span> {t.footer.links.campaigns}
                                </Link>
                            </li>
                            <li>
                                <Link
                                    ...
                                    className="hover:text-white transition-colors flex items-center"
                                >
                                    <span className="mr-2">›</span> {t.footer.links.media}
                                </Link>
                            </li>
                            <li>
                                <Link
                                    ...
                                    className="hover:text-white transition-colors flex items-center"
                                >
                                    <span className="mr-2">›</span> {t.footer.links.getInvolved}
                                </Link>
                            </li>
                        </ul>
                    </div>
